...
class Maze {
    ...
    func addBg() {
        ...
        if Int(blockSize!.width) % 2 == 1 {
            blockSize!.width -= 1
            bg!.position.x += (CGFloat(blockCount!) - CGFloat(blockCount! % 2)) / 2
        }
        ...
        //tiletopright.blendMode = .replace
        ...
        //tilebotright.blendMode = .replace
